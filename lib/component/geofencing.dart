            ...
            child: FlutterMap(
              ...
              options: MapOptions(
                ...
                onTap: (point, latLng) {
                  ...
                  final distanceToDomain =
                      const Distance().as(LengthUnit.Meter, circledomain, latLng);
                  final distanceToDomainTwo =
                      const Distance().as(LengthUnit.Meter, circledomaintwo, latLng);
                  final distanceToThirdCircle =
                      const Distance().as(LengthUnit.Meter, thirdcircle, latLng);
              ...
              children: [
                ...
                CircleLayer(
                  circles: [
                    CircleMarker(
                      point: circledomaintwo,
                      color: Colors.red.withOpacity(0.5), // Fill color
